...
/**
 * Sizes the next resumable chunk from the last acknowledged transfer. Including
 * the server acknowledgement in elapsedMs makes high-latency paths use larger
 * chunks, while the growth cap prevents one unusually fast sample from jumping
 * straight from 8 MiB to the 128 MiB memory ceiling.
 */
